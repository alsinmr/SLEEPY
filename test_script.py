...
pwdavg=RS.PowderAvg(q=3)

H0=RS.Hamiltonian(expsys=expsys,rf=rf,pwdavg=pwdavg)

expsys.remove_inter(Type='dipole')

expsys.set_inter('dipole',delta=22000,i1=0,i2=1,euler=[0,np.pi/4,0])

H1=RS.Hamiltonian(expsys=expsys,rf=rf,pwdavg=RS.PowderAvg(q=3))
